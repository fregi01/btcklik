...
cname = '@BTC_Ads_jp_bot'
crot = 'https://t.me/BTC_Ads_jp_bot'
...
async def main():
	...
	# Free_LTC_Robot
	print_msg_time(Fore.GREEN + f'Name    : @BTC_Ads_jp_bot '  + Fore.RESET)
	...
	while(True):
		...
		print_msg_time(Fore.GREEN + ' Luamyan dapat BTC yaa kan gik ' + choice + Fore.RESET)
		time.sleep(32)
		i = 1
